...
This NLI framing proved highly effective and logically congruent with Subtask 1, as the three native NLI output classes (Entailment, Contradiction, Neutral) directly mapped to the three required clarity labels. However, this approach was not extended to Subtask 2. Since Subtask 2 requires predicting one of nine distinct evasion technique labels, we determined that there was no clear or principled way to construct a single Hypothesis-Premise relationship that could logically correspond to this larger, multi-class set of evasion categories.
