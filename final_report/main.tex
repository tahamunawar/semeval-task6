...
Standard BERT baselines are limited to 512 tokens, often necessitating the truncation of long political responses \citep{b4}. To preserve the full context of sQA pairs, we fine-tune \texttt{modernbert-base} and \texttt{large}, leveraging their native 8192-token sequence length to capture the complete interaction within a single classification head \citep{b8}.
